...
<head>
    ...
    <script src="vues/js/ajouterInput.js" type="text/javascript "></script>
...
<div class="container card mt-5 p-3" id="size-container">
    ...
    <div class="form-group mb-3 mx-auto">
        <form onsubmit="creer_tache()" id="form" method="post">
            ...
            <div id="container">
                <input name="mailMembre[]" id="mailMembre" placeholder="Membre de la tâche">
                <a href="#" id="ajouter" onclick="ajout()">Ajouter</a>
                <span  id="erreur " style="color: red"></span><span  id="ok "></span>

            </div>
            <input name="description" id="description" placeholder="Description de la tâche" id="" class="form-control mt-3 mb-3"  />
            <input name="cout" id="cout" class="form-control mt-3 mb-3" placeholder="Coût de la tâche"/>
            <input type="date" id="datedebut" name="datedebut" placeholder="Date de début"  class="form-control mt-3 mb-3"/>
            <input name="duree" placeholder="Durée" id="duree" class="form-control mt-3 mb-3"  />
            <input class="btn btn-primary" id="submit" value="Créer une tâche" type="submit"/>
        </form>
    </div>
</div>
</body>
